...
>
> **Status (v0.1.105)**: All visual bugs have been fixed. All 26 examples produce correct visual output.
...
**No known issues.** As of v0.1.105, all 2087 tests pass (+ 30 skipped = 2117 collected), all 26 examples (01-26) execute successfully and produce correct output, and mypy/ruff pass.
