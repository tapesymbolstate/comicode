...
> **NOTE (2026-01-18)**: This document's bug analysis is now **obsolete**. All issues described below have been resolved. All 1743 tests pass (1739 pass + 4 skip), all 15 examples (01-15) execute successfully and produce correct output, and mypy/ruff pass. This document is retained for historical reference only.
